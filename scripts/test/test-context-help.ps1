...
if ($output -match "Available Commands") {
    Write-Host "✅ PASS: Basic '?' help works" -ForegroundColor Green
} else {
    Write-Host "❌ FAIL: Basic '?' help not working" -ForegroundColor Red
}
...
if ($output -like "*discover - Discover cloud resources*") {
    Write-Host "✅ PASS: Command-specific help works" -ForegroundColor Green
} else {
    Write-Host "❌ FAIL: Command-specific help not working" -ForegroundColor Red
}
...
if ($output -like "*analyze - Analyze drift for a state file*") {
    Write-Host "✅ PASS: Analyze help works" -ForegroundColor Green
} else {
    Write-Host "❌ FAIL: Analyze help not working" -ForegroundColor Red
}
...
if ($output -like "*perspective - Compare state with live infrastructure*") {
    Write-Host "✅ PASS: Perspective help works" -ForegroundColor Green
} else {
    Write-Host "❌ FAIL: Perspective help not working" -ForegroundColor Red
}
...
if ($output -like "*notify - Send notifications*") {
    Write-Host "✅ PASS: Notify help works" -ForegroundColor Green
} else {
    Write-Host "❌ FAIL: Notify help not working" -ForegroundColor Red
}
...
if ($output -match "Did you mean") {
    Write-Host "✅ PASS: Partial command matching works" -ForegroundColor Green
} else {
    Write-Host "❌ FAIL: Partial command matching not working" -ForegroundColor Red
}
...
if ($output -match "No exact match") {
    Write-Host "✅ PASS: Invalid command handling works" -ForegroundColor Green
} else {
    Write-Host "❌ FAIL: Invalid command handling not working" -ForegroundColor Red
}
...
if ($output -match "DriftMgr Interactive Shell") {
    Write-Host "✅ PASS: Help command still works" -ForegroundColor Green
} else {
    Write-Host "❌ FAIL: Help command broken" -ForegroundColor Red
}

Write-Host "`nContext-Sensitive Help Test Summary:" -ForegroundColor Cyan
Write-Host "=====================================" -ForegroundColor Cyan
Write-Host "✅ Basic '?' help functionality" -ForegroundColor Green
Write-Host "✅ Command-specific help (discover, analyze, perspective, notify)" -ForegroundColor Green
Write-Host "✅ Partial command matching" -ForegroundColor Green
Write-Host "✅ Invalid command handling" -ForegroundColor Green
Write-Host "✅ Backward compatibility with 'help' command" -ForegroundColor Green
