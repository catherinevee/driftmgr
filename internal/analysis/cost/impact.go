...
func (ca *CostAnalyzer) AnalyzeResourceSimple(resource *parser.Resource) *ResourceCostImpact {
...
func estimateResourceCost(resource *parser.Resource) float64 {
...
func estimateDriftCost(resource *parser.Resource) float64 {
...
func calculatePotentialSavings(resource *parser.Resource) float64 {
	currentCost := estimateResourceCost(resource)
...
func analyzeCostIncrease(resource *parser.Resource) string {
	reasons := []string{}
