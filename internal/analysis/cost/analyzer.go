...
func (ca *CostAnalyzer) AnalyzeState(ctx context.Context, state *parser.TerraformState) (*StateCostReport, error) {
...
func (ca *CostAnalyzer) AnalyzeResource(ctx context.Context, resource *parser.Resource, 
	instance *parser.Instance, index int) (*ResourceCost, error) {
...
func (ca *CostAnalyzer) generateRecommendations(state *parser.TerraformState, 
