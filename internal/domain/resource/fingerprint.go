...
func (rf *ResourceFingerprinter) FingerprintResource(resource Resource) *FingerprintResult {
...
func (rf *ResourceFingerprinter) generateFingerprint(resource Resource) string {
...
func (rf *ResourceFingerprinter) detectCreationMethod(resource Resource) CreationMethod {
...
func (rf *ResourceFingerprinter) matchPattern(resource Resource) *Pattern {
...
func (rf *ResourceFingerprinter) calculatePatternMatch(resource Resource, pattern *Pattern) float64 {
	score := 0.0
	matchedIndicators := 0
...
func (rf *ResourceFingerprinter) hasIndicator(resource Resource, indicator string) bool {
	// Check in name
...
func (rf *ResourceFingerprinter) generateSignature(resource Resource) *Signature {
	sig := &Signature{
...
func (rf *ResourceFingerprinter) detectToolFingerprint(resource Resource) string {
...
func (rf *ResourceFingerprinter) detectAnomalies(resource Resource, result *FingerprintResult) []string {
	anomalies := []string{}
...
func (rf *ResourceFingerprinter) BatchFingerprint(resources []Resource) map[string]*FingerprintResult {
...
func (rf *ResourceFingerprinter) LearnPatterns(knownResources map[string]Resource, knownMethods map[string]CreationMethod) {
	// Group resources by creation method
	groups := make(map[CreationMethod][]Resource)
...
func (rf *ResourceFingerprinter) extractPattern(resources []Resource, method CreationMethod) *Pattern {
	if len(resources) == 0 {
		return nil
	}
