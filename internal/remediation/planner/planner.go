...
func (rp *RemediationPlanner) CreatePlan(ctx context.Context, driftReport *detector.DriftReport, 
	state *parser.TerraformState) (*RemediationPlan, error) {
...
func (rp *RemediationPlanner) generateActions(drift detector.DriftResult, 
	state *parser.TerraformState) ([]RemediationAction, error) {
...
func (rp *RemediationPlanner) createRollbackPlan(plan *RemediationPlan, state *parser.TerraformState) *RollbackPlan {
