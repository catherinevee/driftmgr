...
type ProviderHealthChecker interface {
	CheckResource(resource *state.Resource, instance *state.Instance) *HealthReport
...
func (ha *HealthAnalyzer) AnalyzeResource(resource *state.Resource, instance *state.Instance) *HealthReport {
	report := &HealthReport{
...
func (ha *HealthAnalyzer) calculateImpact(resource *state.Resource) ImpactLevel {
	if ha.graph == nil {
...
func (ha *HealthAnalyzer) formatResourceAddress(resource state.Resource, index int) string {
