...
func (c *AWSHealthChecker) CheckResource(resource *state.Resource, instance *state.Instance) *HealthReport {
	report := &HealthReport{
...
func (c *AWSHealthChecker) checkEC2Instance(instance *state.Instance, report *HealthReport) {
...
func (c *AWSHealthChecker) checkS3Bucket(instance *state.Instance, report *HealthReport) {
	if instance.Attributes == nil {
		return
	}
...
func (c *AWSHealthChecker) checkSecurityGroup(instance *state.Instance, report *HealthReport) {
	if instance.Attributes == nil {
		return
	}
...
func (c *AWSHealthChecker) checkRDSInstance(instance *state.Instance, report *HealthReport) {
	if instance.Attributes == nil {
		return
	}
...
func (c *AzureHealthChecker) CheckResource(resource *state.Resource, instance *state.Instance) *HealthReport {
	report := &HealthReport{
		Issues:      make([]HealthIssue, 0),
		Suggestions: make([]string, 0),
	}
...
func (c *AzureHealthChecker) checkVirtualMachine(instance *state.Instance, report *HealthReport) {
	if instance.Attributes == nil {
		return
	}
...
func (c *AzureHealthChecker) checkStorageAccount(instance *state.Instance, report *HealthReport) {
	if instance.Attributes == nil {
		return
	}
...
func (c *GCPHealthChecker) CheckResource(resource *state.Resource, instance *state.Instance) *HealthReport {
	report := &HealthReport{
		Issues:      make([]HealthIssue, 0),
		Suggestions: make([]string, 0),
	}
...
func (c *GCPHealthChecker) checkComputeInstance(instance *state.Instance, report *HealthReport) {
	if instance.Attributes == nil {
		return
	}
...
func (c *GCPHealthChecker) checkStorageBucket(instance *state.Instance, report *HealthReport) {
	if instance.Attributes == nil {
		return
	}
