...
type ValidationRule struct {
	Name        string
	Description string
	Validate    func(*parser.TerraformState) error
	Severity    Severity
}
...
func (v *Validator) Validate(state *parser.TerraformState) error {
	if state == nil {
...
func (v *Validator) addDefaultRules() {
	...
	v.AddRule(ValidationRule{
		...
		Validate: func(state *parser.TerraformState) error {
...
func (v *Validator) validateResource(resource parser.Resource) error {
...
func (v *Validator) validateInstance(resource parser.Resource, index int, instance parser.Instance) error {
