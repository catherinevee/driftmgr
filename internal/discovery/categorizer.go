...
func (rc *ResourceCategorizer) CategorizeResource(resource models.Resource, inState bool) ResourceCategory {
	// Check if in state
	if inState {
...
func (rc *ResourceCategorizer) ScoreImportCandidate(resource models.Resource) *ImportCandidate {
...
func (rc *ResourceCategorizer) isSystemResource(resource models.Resource) bool {
...
func (rc *ResourceCategorizer) isTemporaryResource(resource models.Resource) bool {
...
func (rc *ResourceCategorizer) isShadowIT(resource models.Resource) bool {
	shadowIndicators := 0
...
func (rc *ResourceCategorizer) wasManaged(resource models.Resource) bool {
...
func (rc *ResourceCategorizer) shouldBeManaged(resource models.Resource) bool {
...
func (rc *ResourceCategorizer) detectEnvironment(resource models.Resource) string {
	// Check tags
	if tags, ok := resource.Tags.(map[string]string); ok {
...
func (rc *ResourceCategorizer) followsNamingConvention(resource models.Resource) bool {
...
func (rc *ResourceCategorizer) getMissingRequiredTags(resource models.Resource) []string {
...
func (rc *ResourceCategorizer) findDependencies(resource models.Resource) []string {
...
func (rc *ResourceCategorizer) getResourceAge(resource models.Resource) time.Duration {
...
func (rc *ResourceCategorizer) hasAutomationTags(resource models.Resource) bool {
	if tags, ok := resource.Tags.(map[string]string); ok {
...
func (rc *ResourceCategorizer) hasAutomationIndicators(resource models.Resource) bool {
...
func (rc *ResourceCategorizer) hasSecurityImplications(resource models.Resource) bool {
...
func (rc *ResourceCategorizer) estimateCost(resource models.Resource) float64 {
...
func (rc *ResourceCategorizer) isConsoleCreated(resource models.Resource) bool {
...
func (rc *ResourceCategorizer) mapToTerraformType(resource models.Resource) string {
...
func (rc *ResourceCategorizer) generateImportCommand(resource models.Resource, tfType string) string {
...
func (rc *ResourceCategorizer) estimateImportImpact(resource models.Resource) string {
	if rc.hasSecurityImplications(resource) {
