...
func (s *Server) handleSendNotification(w http.ResponseWriter, r *http.Request) {
	...
	// Convert channels
	// TODO: Define notifications.Channel type
	channels := []string{}
	...
	// Create notification
	// TODO: Define notifications.Notification type
	...
	// defer cancel()
	_ = r.Context() // Use context to avoid unused variable error
	
	// TODO: Implement notifier.Send
	...
	s.respondJSON(w, http.StatusOK, map[string]interface{}{
		...
		"id":      "placeholder-id", // notification["id"],
	})
}
...
func (s *Server) handleNotificationHistory(w http.ResponseWriter, r *http.Request) {
	...
	// Get history
	// TODO: Implement notifier.GetHistory
...
func (s *Server) handleTestNotification(w http.ResponseWriter, r *http.Request) {
	...
	// TODO: Define notifications.Notification
	notification := map[string]interface{}{
		"type":     "info",
	...
	if req.Channel != "" {
		notification["channels"] = []string{req.Channel}
	}
